...
{	
	...
	*/
	...
	unsigned char alphabet[N] = { 'А','Б','В','Г','Д','Е','Ж','З','И','Й','К','Л','М','Н','О','П','Р','С','Т','У','Ф','Х','Ц','Ч','Ш','Щ','Э','Й','Ы','Ь','Ю','Я' };
	unsigned char savealphabet[N]= { 'А','Б','В','Г','Д','Е','Ж','З','И','Й','К','Л','М','Н','О','П','Р','С','Т','У','Ф','Х','Ц','Ч','Ш','Щ','Э','Й','Ы','Ь','Ю','Я' };
